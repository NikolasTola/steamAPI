...
const chaveAcesso = '2627FEB2EFFCED8437F659EB577291EE';
...
var steamResponse2 = await fetch(`http://api.steampowered.com/IPlayerService/GetOwnedGames/v0001/?key=${chaveAcesso}&steamid=${id}&format=json`);
